...
console.info('\n===== Codepoint Order =====\n')
display(codepointOrder())

console.info('\n===== Vertical Binary Order =====\n')
display(verticalBinaryOrder())

console.info('\n===== Horizontal Binary Order =====\n')
display(horizontalBinaryOrder())
...
function horizontalBinaryOrder () {
  const bitMap = new Map()
  bitMap.set(0,     0)
  bitMap.set(1,     1)
  bitMap.set(2,     8)
